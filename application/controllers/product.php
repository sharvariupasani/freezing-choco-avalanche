			...
			array( 'db' => 'p.id',
					...
					'formatter' => function( $e, $row ) {
						...
						if (hasAccess("product","edit"))
							$op[] = '<a href="'.site_url('/product/edit/'.$e).'" class="fa fa-edit"></a>';

						if (hasAccess("product","add"))
						{
							$op[] = '<a href="javascript:void(0);" onclick="manage_stock_modal(\'plus\','.$e.')" class="fa fa-plus"></a>';
							$op[] = '<a href="javascript:void(0);" onclick="manage_stock_modal(\'minus\','.$e.')" class="fa fa-minus"></a>';
						}

						if (hasAccess("purchase","ajax_list"))
							$op[] = '<a href="javascript:void(0);" onclick="stock_history('.$e.')" class="fa fa-table"></a>';

						if (hasAccess("product","delete"))
							$op[] = '<a href="javascript:void(0);" onclick="delete_product('.$e.')" class="fa fa-trash-o"></a>';
